...
const getWeatherIcon = (code, is_day) => {
  ...
  switch (code) {
    // --- Clear Sky ---
    case 0:
      return `/Weather-app-using-react/assets/images/0_${is_day ? "0" : "1"}.png`;

    // --- Mainly clear, partly cloudy, overcast ---
    case 1:
    case 2:
       return `/Weather-app-using-react/assets/images/${code}_${is_day ? "0" : "1"}.png`;
    case 3: return "/Weather-app-using-react/assets/images/3_0.png"
     

    // --- Fog & rime fog ---
    case 45:
    case 48:
      return "/Weather-app-using-react/assets/images/45_48.png";

    // --- Drizzle: light, moderate, dense ---
    case 51:
    case 53:
    case 55:
      return `/Weather-app-using-react/assets/images/${code}.png`;

    // --- Freezing drizzle ---
    case 56:
    case 57:
      return "/Weather-app-using-react/assets/images/56_57.png";
    ...
    case 66:
    case 67:
      return "/Weather-app-using-react/assets/images/66_67.png";
    ...
    // --- Snow grains ---
    case 77:
      return "/Weather-app-using-react/assets/images/77.png";
    ...
    case 85:
    case 86:
      return `/Weather-app-using-react/assets/images/85_86_${is_day ? "0" : "1"}.png`;

    // --- Thunderstorm ---
    case 95:
      return "/Weather-app-using-react/assets/images/95.png";

    // --- Thunderstorm with hail ---
    case 96:
    case 99:
      return "/Weather-app-using-react/assets/images/96_99.png";

    // --- Default fallback ---
    default:
      return `/Weather-app-using-react/assets/images/1_${is_day ? "0" : "1"}.png`;
  }
};
  ...
  return (
    ...
    <> 
   <div className='min-h-screen w-full  bg-cover bg-no-repeat bg-center text-white '  style={{ backgroundImage: 'url("/Weather-app-using-react/assets/bgImages/partlynightcloud.webp")' }}>
           <Nav
